...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 mt-4 text-center">
            <form action="{{ route('todolist.createpost', session('token')) }}" method="post">
                            ...
                            <div class ="col-10">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control form-control-content" name="content" cols="40" rows="5"></textarea>
                                        </div>  
